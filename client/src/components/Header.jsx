...
export default function Header() {
  ...
  return (
    <header
      style={{
        height: "78px",
        background: "linear-gradient(90deg, #1976D2 0%, #0d4d8f 100%)",
        display: "flex",
    ...
    >
      <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
        <div>
          ...
          <div style={{ color: "#cfe3fa", fontSize: "12.5px", marginTop: "2px" }}>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: "22px" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
          ...
          <div>
            ...
            <div style={{ fontSize: "11.5px", color: "#cfe3fa" }}>{userRole}</div>
          </div>
        </div>
  ...
  return (
    <div
      style={{
        ...
        display: "flex", alignItems: "center", justifyContent: "center",
        background: "rgba(255,255,255,0.15)", cursor: "pointer", transition: "0.2s",
      }}
