...
export default function EditEmployee() {
  ...
  const loadEmployee = async () => {
    try {
      ...
      console.error(err);
      showToast("Unable to load employee", "error");
    }
  };
  ...
  return (
    <MainLayout>
      <Box sx={{ p: 3 }}>
        ...
        <Typography variant="h4" fontWeight="bold" mb={1}>Edit Employee</Typography>
        <Typography color="text.secondary" mb={3}>Update employee information below.</Typography>
