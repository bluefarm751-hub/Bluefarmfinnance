...
export default function About() {
  ...
  return (
    <MainLayout>
      {/* ================= PAGE CARD (wraps the whole page) ================= */}
      <Box
        sx={{
          minHeight: "100%",
          display: "flex",
      ...
      >
        ...
        >
          ...
          {/* ================= MODULES SECTION (inside the same page card) ================= */}
          <Box sx={{ mt: 5 }}>
          ...
          <Box sx={{ textAlign: "center", pt: 4, opacity: 0.6 }}>
...
function ModuleCard({ icon, title, desc, accentGradient }) {
  return (
    <Box sx={{
      ...
      borderRadius: 4,
      p: 2.6,
      boxShadow: "0 10px 26px rgba(8,33,63,0.10)",
      border: "1px solid rgba(15,76,129,0.08)",
      display: "flex",
      ...
      "&:hover": {
        ...
        boxShadow: "0 22px 50px rgba(8,33,63,0.18)",
      },
    }}>
      <Box sx={{
