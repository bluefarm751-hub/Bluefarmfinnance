...
export default function BalanceSheetFullDetailPdf() {
  ...
  return <MainLayout><Box sx={{ px: 3, pt: 1, pb: 4 }}>
    ...
    <SectionCard title={<><FaFilePdf style={{ marginRight: 8, verticalAlign: -2 }} />Full Bill Detail — {farm}</>} action={<Button variant="contained" color="error" startIcon={<FaFilePdf / className="bf-export-button bf-export-pdf">} disabled={loading || !data.rows?.length} onClick={buildPdf}>Generate Full PDF</Button>}>
